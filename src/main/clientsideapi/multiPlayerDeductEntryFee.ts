...
import {
  multiPlayerDeductEntryFeeIf,
  multiPlayerDeductEntryFeeResponse,
} from '../interface/cmgApiIf';
...
async function multiPlayerDeductEntryFee(
  data: multiPlayerDeductEntryFeeIf,
  token: string,
  socketId: string,
): Promise<multiPlayerDeductEntryFeeResponse> {
  ...
  try {
    ...
    const multiPlayerDeductEntryFeeDetails = responce.data.data;
    Logger.info(
      tableId,
      'resData : multiPlayerDeductEntryFee :: ',
      multiPlayerDeductEntryFeeDetails,
    );
    ...
    Logger.error(
      tableId,
      'CATCH_ERROR :  multiPlayerDeductEntryFeeDetails :>> ',
      data,
      token,
      '-',
      error,
