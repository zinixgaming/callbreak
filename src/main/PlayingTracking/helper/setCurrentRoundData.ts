...
async function setCurrentRoundData(tableId: string, data: any, userScore: userScoreIf[], winningAmount: winnLossAmountIf[]): Promise<any> {
    try {
        ...
        logger.error(tableId,'CATCH_ERROR : setCurrentRoundData :>> ', error, ' - ');
    }
}
